...
$action = New-ScheduledTaskAction -WorkingDirectory "C:\actions-runner" -Execute "PowerShell.exe" -Argument "Start-Transcript -Path "C:\runner-startup.log" -Append; ${start_runner}; Stop-Transcript"
